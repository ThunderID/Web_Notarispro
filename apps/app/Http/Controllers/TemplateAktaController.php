...
class TemplateAktaController extends Controller
{
	...
	public function show($id)
	{
		...
		// tes data
		// $parsing 		= '{"status":"success","data":{"page_info":{"id":"5850a0bab6cf8a00080d60c2"},"page_data":{"title":{"header":["title"],"data":{"title":"Akta Pemberian Hak Tanggungan"}},"content":{"header":["paragraph_0","paragraph_1","paragraph_2"],"data":[{"paragraph_0":"Pada hari ini, Senin, tanggal 28 Agustus 2016 hadir dihadapan saya, ANNA WONG, sarjana Hukum yang berdasarkan SK BPN tanggal 23 April 2003 nomor 6-XA-2003. Diangkat sebagai Pejabat Pembuat Akta Tanah yang selanjutnya disebut PPAT yang dimaksud dalam pasal 7 Peraturan Pemerintah Nomor 24 Tahun 1997 tentang pendaftaran Tanah, dengan daerah kerja kota Administrasi Jakarta Utara dan berkantor di Komplek Ruko Grand Boutique Centre Blok A Nomor 9, Jalan Mangga Dua, Jakarta 14430. Dengan dihadiri oleh saksi - saksi yang saya kenal akan disebut pada bagian akhir akta ini :"},{"paragraph_1":"I’ve never owned a retail business, but I worked a variety of retail jobs growing up. What Apple did with retail was different. I was captivated when Apple opened its first set of physical retail stores in 2001. I’ve never owned a retail business, but I worked a variety of retail jobs growing up. What Apple did with retail was different .I was captivated when Apple opened its first set of physical retail stores in 2001. I’ve never owned %input% a retail business, but I worked a variety of retail jobs growing up. What Apple did with retail was different"},{"paragraph_2":"When Apple finally opened one in the Chicago area over a decade ago, I rushed over there. I was in awe. What a unique retail experience. Just wonderful."}]},"ownership":{"header":["writer","owner"],"data":{"writer":"pname","writerid":"pid","owner":"oname","ownerid":"oid"}}}}}';
		// $result 		= json_decode($parsing, true);
